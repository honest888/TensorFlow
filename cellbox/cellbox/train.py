...
from tensorflow._api.v2.compat.v1.errors import OutOfRangeError
...
def train_model(model, args):
    ...
    for i in tf_v1.get_collection(tf_v1.GraphKeys.GLOBAL_VARIABLES, scope='initialization'):
        print(i)

    # Initialization
    args.saver = tf_v1.train.Saver()
    from tensorflow.core.protobuf import rewriter_config_pb2
